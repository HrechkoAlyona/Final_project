...
// API
import { useGetMeQuery, useSearchUsersQuery, getSocket } from '../../services/api'; 
// Добавили useMarkConversationAsReadMutation
import { useGetMyConversationsQuery, useMarkConversationAsReadMutation } from '../../services/chatApi'; 
        ...
        <div className={s.list}>
          ...
          {conversations.map((chat) => (
            <div 
              ...
              // ВАЖНО: Используем handleChatClick вместо простого setSelectedUser
          ...
          <div className={s.modalContent} onClick={(e) => e.stopPropagation()}>
             ...
             <div className={s.searchResults}>
                {searchResults.map(user => (
                  <div key={user._id} className={s.userResult} onClick={() => handleSelectUserFromSearch(user)}>
